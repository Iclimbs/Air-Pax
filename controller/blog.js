...
BlogRouter.post("/popularblog/add", upload.single("img"), async (req, res) => {
    ...
    try {
        ...
        res.json({ status: "error", message: `Failed To Add New Popular Blog ${error.message}` })
    }
})
...
BlogRouter.patch("/popularblog/disable/:id", async (req, res) => {
    ...
    try {
        ...
        await popularblog.save()
        res.json({ status: "success", message: "Popular Blog Item Availability Updated !!" })
    } catch (error) {
        res.json({ status: "error", message: `Failed To Update Popular Blog Item Availability ${error.message}` })
    }
})
...
BlogRouter.get("/popularblog/listall", async (req, res) => {
    try {
        ...
        if (popularBlogList.length !== 0) {
            ...
            res.json({ status: "error", message: "No Blog Found In Popular Seaction" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Popular Blog List ${error.message}` })
    }
})
...
BlogRouter.get("/popularblog/listall/active", async (req, res) => {
    try {
        ...
        if (popularBlogList.length !== 0) {
            ...
            res.json({ status: "error", message: "No Active Blog Found In Popular Seaction" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Active Popular Blog List ${error.message}` })
    }
})
...
BlogRouter.get("/activitycardblog/listall", async (req, res) => {
    try {
        ...
        if (activityCardList.length !== 0) {
            ...
            res.json({ status: "error", message: "No Blog Found In Activity Seaction" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Activity Blog List ${error.message}` })
    }
})
...
BlogRouter.get("/activitycardblog/listall/active", async (req, res) => {
    try {
        ...
        if (activityCardList.length !== 0) {
            ...
            res.json({ status: "error", message: "No Active Blog Found In Activity Seaction" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Activity Blog List ${error.message}` })
    }
...
BlogRouter.patch("/activity/edit/:id", upload.single("img"), async (req, res) => {
    ...
    try {
        ...
        await activityblog.save()
        res.json({ status: "success", message: "Activity Details Successfully Updated !!" })
    } catch (error) {
...
BlogRouter.patch("/activity/disable/:id", async (req, res) => {
    ...
    try {
        ...
        activityblog.status = !activityblog.status;
        await activityblog.save()
        res.json({ status: "success", message: "Activity Details Availability Updated !!" })
    } catch (error) {
        res.json({ status: "error", message: `Failed To Update Food Item Availability Details ${error.message}` })
    }
})
...
BlogRouter.get("/activity/listall", async (req, res) => {
    try {
        ...
        if (activityList.length > 0) {
            ...
            res.json({ status: "error", message: "No Blog Found in Activity Section" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Activity List ${error.message}` })
    }
})
...
BlogRouter.get("/activity/listall/active", async (req, res) => {
    try {
        ...
        if (activityList.length > 0) {
            ...
            res.json({ status: "error", message: "No Active Blog Found in Activity Section" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Active Activity List ${error.message}` })
    }
})
...
BlogRouter.get("/featuredblog/listall", async (req, res) => {
    try {
        ...
        if (featuredList.length > 0) {
            ...
            res.json({ status: "error", message: "No Featured Blog Found in Featured Section" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Featured List Item Details ${error.message}` })
    }
})
...
BlogRouter.get("/featuredblog/listall/active", async (req, res) => {
    try {
        ...
        if (featuredList.length > 0) {
            ...
            res.json({ status: "error", message: "No Active Featured Blog Found in Featured Section" })
        }
    } catch (error) {
        res.json({ status: "error", message: `Failed To Get Active Featured List Item Details ${error.message}` })
    }
})
